...
export default function AdminPanelPage() {
  ...
  return <main className="admin-panel-shell">
    <aside className="admin-sidebar"><Link href="/" className="admin-brand"><span>MV</span><b>ADVOGADO</b></Link><div className="admin-sidebar-label">GESTÃO DO SITE</div><nav className="admin-side-nav"><a className="is-active" href="#fotos">Fotos</a><a href="#artigos">Artigos</a><Link href="/#contactos">Ver site público <ExternalLink /></Link></nav><button className="admin-logout" onClick={() => getSupabaseClient().auth.signOut()}><LogOut /> Sair</button></aside>
