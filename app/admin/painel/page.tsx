  ...
  return (
    <main className="admin-panel-shell">
      ...
      <section className="admin-content">
        ...
        <div className="admin-actions"><Link className="admin-action-link" href="/admin/painel/fotos"><ImagePlus /> Adicionar Foto</Link><Link className="admin-action-link" href="/admin/painel/artigos"><FileText /> Criar Artigo</Link></div>
